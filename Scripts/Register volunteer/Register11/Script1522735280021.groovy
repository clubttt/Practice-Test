...
def randomLastNameTH = CustomKeywords.'generateEmail.genEmail.randomString'('กขคฆงจฉชซฐฏฤๆไำพะัีรึภถุูฃฅบยญ๊รธะฑพฟหฆกฏดโฌเ็้่าษสศวฦฝฬใฒฒทื์ิฮอแปผ', 
    12)
def randomAdd = CustomKeywords.'generateEmail.genEmail.randomString'('กขคฆงจฉชซฐฏฤๆไำพะัีรึภถุูฃฅบยญ๊รธะฑพฟหฆกฏดโฌเ็้่าษสศวฦฝฬใฒฒทื์ิฮอแปผabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456489/*-+ๅ/-$%^&*()_',
	 5)
...
WebUI.setText(findTestObject('Register_Page/input_ADDRESS_NO'), ''+randomAdd+'')
