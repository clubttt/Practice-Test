...
def randomName = CustomKeywords.'generateEmail.genEmail.randomString'('กขคฆงจฉชซฐฏฤๆไำพะัีรึภถุูฃฅบยญ๊รธะฑพฟหฆกฏดโฌเ็้่าษสศวฦฝฬใฒฒทื์ิฮอแปผabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456489/*-+ๅ/-$%^&*()_', 
    12)
...
WebUI.setText(findTestObject('Register_Page/input_FIRST_NAME_TH'), ('' + randomName) + '')

WebUI.setText(findTestObject('Register_Page/input_LAST_NAME_TH'), ('' + randomName) + '')

WebUI.setText(findTestObject('Register_Page/input_FIRST_NAME_EN'), ('' + randomName) + '')

WebUI.setText(findTestObject('Register_Page/input_LAST_NAME_EN'), ('' + randomName) + '')
