...
WebUI.selectOptionByValue(findTestObject('Register_Page/ADDRESS_DISTRICT'), '', false)

WebUI.delay(2)

WebUI.selectOptionByValue(findTestObject('Register_Page/ADDRESS_SUBDISTRICT'), '', false)
