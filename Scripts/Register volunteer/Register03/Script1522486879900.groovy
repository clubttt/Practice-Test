...
def randomPL = CustomKeywords.'randomPass.randomPass.randomString'('abcdefghijklmnopqrstuvwxty123456789', 3)
...
WebUI.setText(findTestObject('Register_Page/input_PASSWORD'), ''+randomPL+'')

WebUI.setText(findTestObject('Register_Page/input_password_confirmation'), ''+randomPL+'')
...
WebUI.verifyTextPresent('กรุณากรอกรหัสผ่านของท่านอย่างน้อย4ตัว', false)
